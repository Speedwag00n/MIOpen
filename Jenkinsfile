...
def buildHipClangJob(Map conf=[:]){
        ...
        def dockerOpts="-u 0:0 --ipc=host --network=host --device=/dev/kfd --device=/dev/dri --group-add video --group-add render --cap-add=SYS_PTRACE --security-opt seccomp=unconfined"
